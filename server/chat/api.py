...
"""
    This View is used to give the previous messages of workspace
    activity. If the workspace_is in query params is given then
    it will return the messages of that workspace room else it will
    return all the messages of all workspace rooms.
"""
